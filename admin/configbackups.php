        ...
        switch ($type) {
            case "cpanel":
                ...
                if(array_key_exists("error", $response)) {
                    ...
                    } elseif(isset($response["error"]["cpanelresult"]) && isset($response["error"]["cpanelresult"]["error"])) {
    ...
    try {
        ...
        switch ($type) {
            case "cpanel":
                ...
                } elseif(!$save_arr["CpanelBackupDestinationPort"]) {
...
$largeBackupWarning = WHMCS\View\Helper::alert(AdminLang::trans("backups.largeBackups") . " <a href=\"https://go.whmcs.com/1873/database-backups#large-installations-and-backups\" target=\"_blank\">" . AdminLang::trans("healthCheck.readMore") . "</a>", "info");
ob_start();
