...
if($type == "support") {
    ...
    echo "</a></td><td>{\$invoice_link}</td></tr>\n<tr>\n    <td>\n        <a href=\"#\" onclick=\"insertMergeField('invoice_url');return false\">\n            ";
    echo AdminLang::trans("mergefields.invoiceurl");
    ...
    echo "</td><td>{\$service_cancellation_type}</a></td></tr>\n<tr><td><a href=\"#\" onclick=\"insertMergeField('service_is_immediate_cancellation');return false\">";
    echo AdminLang::trans("mergefields.immediateCancel");
    echo "</td><td>{\$service_is_immediate_cancellation}</a></td></tr>\n<tr><td><a href=\"#\" onclick=\"insertMergeField('service_username');return false\">";
...
} elseif($type === "admin_invite") {
    echo "    <b>";
    echo AdminLang::trans("mergefields.adminInvite");
    echo "</b><br />\n    <table>\n        <tr>\n            <td width=\"150\">\n                <a href=\"#\" onclick=\"insertMergeField('invite_email');return false\">\n                    ";
    echo AdminLang::trans("fields.inviteEmail");
    echo "                </a>\n            </td>\n            <td>{\$invite_email}</a></td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('invite_sender_name');return false\">\n                    ";
    echo AdminLang::trans("fields.inviteSenderName");
    echo "                </a>\n            </td>\n            <td>{\$invite_sender_name}</a></td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('invite_accept_url');return false\">\n                    ";
    echo AdminLang::trans("fields.inviteAcceptUrl");
    echo "                </a>\n            </td>\n            <td>{\$invite_accept_url}</a></td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('expiration_period_in_days');return false\">\n                    ";
    echo AdminLang::trans("fields.invitationExpires");
    echo "                </a>\n            </td>\n            <td>{\$expiration_period_in_days}</a></td>\n        </tr>\n    </table>\n";
} elseif($type == "admin") {
    if($name == "New Order Notification") {
    ...
    } elseif($name == "Automatic Setup Successful" || $name == "Automatic Setup Failed" || $name == "Service Unsuspension Failed" || $name == "Service Unsuspension Successful") {
        echo "<b>";
        ...
        echo $aInt->lang("mergefields", "errormsg");
        echo "</td><td>{\$error_msg}</a></td></tr>\n</table><br />\n";
    } elseif($name == "Support Ticket Change Notification") {
        echo "<b>";
        echo $aInt->lang("mergefields", "support");
        echo "</b><br />\n<table>\n<tr><td width=\"150\"><a href=\"#\" onclick=\"insertMergeField('ticket_id');return false\">";
        echo $aInt->lang("fields", "id");
...
if(!in_array($type, ["support", "admin", "notification", "user", "invite", "admin_invite"])) {
    echo "<b>";
    echo $aInt->lang("mergefields", "client");
    echo "</b><br />\n<table>\n<tr><td width=\"150\"><a href=\"#\" onclick=\"insertMergeField('client_id');return false\">";
    echo $aInt->lang("fields", "id");
