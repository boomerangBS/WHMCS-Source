...
if(App::getFromRequest("intellisearch")) {
    ...
    if($type == "clients") {
        ...
        if($field == "Order ID") {
            ...
            $searchin = "ordernum";
        } elseif($field == "Order Date") {
            $searchin = "orderdate";
        } elseif($field == "Client Name") {
            $searchin = "clientname";
        } elseif($field == "Amount") {
            $searchin = "amount";
        }
        ...
        if($field == "ID" || $field == "Service ID") {
            ...
            $searchin = "clientname";
        } elseif($field == "Package" || $field == "Product") {
            $searchin = "productname";
        } elseif($field == "Billing Cycle") {
            $searchin = "billingcycle";
        } elseif($field == "Next Due Date") {
            $searchin = "nextduedate";
        } elseif($field == "Status") {
            $searchin = "status";
        } elseif($field == "Username") {
            $searchin = "username";
        } elseif($field == "Dedicated IP") {
            $searchin = "dedicatedip";
        } elseif($field == "Assigned IPs") {
            $searchin = "assignedips";
        } elseif($field == "Subscription ID") {
        ...
        if($field == "Invoice #") {
            ...
            $searchin = "clientname";
        } elseif($field == "Line Item") {
            $searchin = "lineitem";
        } elseif($field == "Invoice Date") {
            $searchin = "invoicedate";
        } elseif($field == "Due Date") {
            $searchin = "duedate";
        } elseif($field == "Date Paid") {
            $searchin = "datepaid";
        } elseif($field == "Total Due") {
