...
if($sub == "save") {
    ...
    if($settingsToSave["InvoiceAutoCancellationDays"] < 0) {
        $settingsToSave["InvoiceAutoCancellationDays"] = 0;
    }
    ...
    foreach ($currentConfig as $setting => $value) {
        ...
        } elseif(isset($settingsToSave[$setting])) {
        } elseif($savedConfig[$setting] != $value) {
...
if(App::getFromRequest("cronhourchanged")) {
    echo WHMCS\View\Helper::alert(AdminLang::trans("automation.changeOfDailyCronHourHelpText") . " <a href=\"https://go.whmcs.com/1869/daily-task-run\" target=\"_blank\" class=\"alert-link\">" . AdminLang::trans("global.learnMore") . " &raquo;</a>", "info");
}
...
$invoiceAutoCancellationChecked = "";
if(($CONFIG["InvoiceAutoCancellation"] ?? "") == "on") {
    $invoiceAutoCancellationChecked = " checked";
}
...
echo "</label></td></tr>\n<tr>\n    <td class=\"fieldlabel\">";
echo AdminLang::trans("automation.invoiceAutoCancellation");
echo "</td>\n    <td class=\"fieldarea\">\n        <label class=\"checkbox-inline\">\n            <input type=\"checkbox\"\n                   name=\"invoiceautocancellation\"";
echo $invoiceAutoCancellationChecked;
echo ">\n            ";
echo AdminLang::trans("automation.invoiceAutoCancellationInfo");
echo "</label>\n    </td>\n</tr>\n<tr>\n    <td class=\"fieldlabel\">";
echo AdminLang::trans("automation.invoiceAutoCancellationDaysDue");
echo "</td>\n    <td class=\"fieldarea\">\n        <input type=\"text\"\n               name=\"invoiceautocancellationdays\"\n               value=\"";
echo (int) ($CONFIG["InvoiceAutoCancellationDays"] ?? 0);
echo "\"\n               class=\"form-control input-50 input-inline\">\n        ";
echo AdminLang::trans("automation.invoiceAutoCancellationDaysDueInfo");
echo "    </td>\n</tr>\n</table>\n\n<h2>";
