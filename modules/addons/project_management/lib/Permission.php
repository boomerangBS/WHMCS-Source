...
class Permission
{
    protected $permissions = ["Create New Projects", "View All Projects", "13" => "View Only Assigned Projects", "2" => "Edit Project Details", "3" => "Update Status", "4" => "Create Tasks", "5" => "Edit Tasks", "6" => "Delete Tasks", "7" => "Bill Tasks", "8" => "Associate Tickets", "9" => "Post Messages", "10" => "View Reports", "11" => "Delete Messages", "12" => "Delete Projects", "View Recent Activity", "Associate Invoice"];
    ...
    public function check($permissionName)
    {
        ...
        $permission = false;
        if(isset($reversedPermissions[$permissionName]) && isset($permissions[$reversedPermissions[$permissionName]][$roleId])) {
            $permission = $permissions[$reversedPermissions[$permissionName]][$roleId];
        }
        return $permission || $this->isMasterAdmin();
    }
