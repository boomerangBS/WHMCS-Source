...
class Project
{
    ...
    protected $language = [];
    private $permissions;
    public function __construct(ComplexPermission $permissions, $projectId, array $language = [])
    {
        if(!$projectId) {
        ...
        foreach ($data as $key => $value) {
            ...
            } elseif(in_array($key, $this->dateValues)) {
    ...
    public static function create($vars)
    {
        ...
        if(isset($_REQUEST["ajax"]) && $_REQUEST["ajax"]) {
        ...
        } elseif(project_management_checkperm("Create New Projects") && trim($_REQUEST["title"])) {
            ...
            $project = Container::getInstance()->make("WHMCS\\Module\\Addon\\ProjectManagement\\Project", ["projectId" => $projectid, "language" => $vars["_lang"]]);
    ...
    public function saveProject()
    {
        ...
        if(0 < count($changes)) {
            ...
            } elseif(!in_array($status, $completedStatuses) && $this->completed) {
                $completed = false;
    ...
    public function permissions() : ComplexPermission
    {
        return $this->permissions;
    }
    public function duplicateProject()
    {
        if(!$this->permissions()->check("Create New Projects")) {
