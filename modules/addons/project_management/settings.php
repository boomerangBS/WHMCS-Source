...
if(!empty($_POST["save"])) {
    ...
    $completeStatus = App::getFromRequest("completestatus");
    if(empty($completeStatus)) {
        $completeStatus = [];
    }
    insert_query("tbladdonmodules", ["module" => "project_management", "setting" => "completedstatuses", "value" => implode(",", $completeStatus)]);
    ...
    insert_query("tbladdonmodules", ["module" => "project_management", "setting" => "clientenable", "value" => $_POST["clientenable"] ?? NULL]);
    delete_query("tbladdonmodules", ["module" => "project_management", "setting" => "clientfeatures"]);
    $clientfeatures = App::getFromRequest("clfeat");
    if(is_array($clientfeatures)) {
        $clientfeatures = implode(",", $clientfeatures);
    }
    insert_query("tbladdonmodules", ["module" => "project_management", "setting" => "clientfeatures", "value" => $clientfeatures]);
...
$clfeat = [];
if(isset($vars["clientfeatures"]) && 0 < strlen($vars["clientfeatures"])) {
    $clfeat = explode(",", (string) $vars["clientfeatures"]);
}
echo "\n<table class=\"form\" width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"3\">\n<tr>\n    <td width=\"200\" class=\"fieldlabel\">Enable/Disable</td>\n    <td class=\"fieldarea\">\n        <label class=\"checkbox-inline\">\n            <input type=\"checkbox\" name=\"clientenable\"\n                value=\"1\" ";
echo !empty($vars["clientenable"]) ? "checked" : "";
echo "            /> Check to enable Client Area Project Access</label>\n    </td>\n</tr>\n<tr><td class=\"fieldlabel\">Allow Access To</td><td class=\"fieldarea\">\n    <blockquote>\n        <label class=\"checkbox-inline\">\n            <input type=\"checkbox\" name=\"clfeat[]\"\n                value=\"tasks\" ";
echo in_array("tasks", $clfeat) ? "checked" : "";
echo "            /> View Project Tasks</label>\n        <br>\n        <label class=\"checkbox-inline\"><input type=\"checkbox\" name=\"clfeat[]\" value=\"time\"";
