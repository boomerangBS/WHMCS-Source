...
{
    return ["DisableCheckoutAutoRedirect" => true, "SupportsEmailPaymentLink" => false, "noCurrencyConversion" => true, "obsolete" => true, "supersededBy" => ["paypal_ppcpv"]];
}
...
function paypalcheckout_post_checkout($params)
{
    ...
    $clientId = (string) (!empty($params["sandbox"]) ? $params["sandboxClientId"] : $params["clientId"]);
    try {
...
function paypalcheckout_config_post_save(array $params = [])
{
...
function paypalcheckout_ListDisputes()
{
    $nextPageToken = NULL;
...
function paypalcheckout_FetchDispute($params) : WHMCS\Billing\Payment\Dispute
{
