...
if($tipo_pagamento == "BoletoBancario") {
    ...
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "DebitoBancario") {
    $tp_pagamento = "Débito Bancário";
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "FinanciamentoBancario") {
    $tp_pagamento = "Financiamento Bancário";
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "CartaoDeCredito") {
    $tp_pagamento = "CartÃ£o de Crédito";
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "CartaoDeDebito") {
    $tp_pagamento = "CartÃ£o de Débito";
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "CarteiraMoIP") {
    $tp_pagamento = "Carteira Moip";
    $vr_taxa = 0;
    $percentual = 0;
} elseif($tipo_pagamento == "NaoDefinida") {
    $tp_pagamento = "NÃ£o definida";
} elseif($tipo_pagamento == "") {
