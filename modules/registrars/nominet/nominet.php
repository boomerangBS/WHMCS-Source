...
function nominet_getLegalTypeID($LegalType)
{
    ...
    if($LegalType == "Individual") {
        $LegalTypeID = "IND";
    } elseif($LegalType == "UK Limited Company") {
        $LegalTypeID = "LTD";
    } elseif($LegalType == "UK Public Limited Company") {
        $LegalTypeID = "PLC";
    } elseif($LegalType == "UK Partnership") {
        $LegalTypeID = "PTNR";
    } elseif($LegalType == "Sole Trader") {
        $LegalTypeID = "STRA";
    } elseif($LegalType == "UK Limited Liability Partnership") {
        $LegalTypeID = "LLP";
    } elseif($LegalType == "UK Industrial/Provident Registered Company") {
        $LegalTypeID = "IP";
    } elseif($LegalType == "UK School") {
        $LegalTypeID = "SCH";
    } elseif($LegalType == "UK Registered Charity") {
        $LegalTypeID = "RCHAR";
    } elseif($LegalType == "UK Government Body") {
        $LegalTypeID = "GOV";
    } elseif($LegalType == "UK Corporation by Royal Charter") {
        $LegalTypeID = "CRC";
    } elseif($LegalType == "UK Statutory Body") {
        $LegalTypeID = "STAT";
    } elseif($LegalType == "UK Entity (other)") {
        $LegalTypeID = "OTHER";
    } elseif(in_array($LegalType, ["Non-UK Individual (representing self)", "Non-UK Individual"])) {
        $LegalTypeID = "FIND";
    } elseif($LegalType == "Foreign Organization") {
        $LegalTypeID = "FCORP";
    } elseif($LegalType == "Other foreign organizations") {
        $LegalTypeID = "FOTHER";
    }
    return $LegalTypeID;
}
