...
function webnic_RegisterDomain($params)
{
    ...
    if($params["companyname"] == "-") {
        ...
        if($usorgtype == "Permanent resident of U.S") {
            $usorgtype = "C12";
        } elseif($usorgtype == "Entity with office in US") {
            $usorgtype = "C32";
        } elseif($usorgtype == "Entity that regularly engages in lawful activities") {
            $usorgtype = "C31";
        } elseif($usorgtype == "Citizen of U.S") {
            $usorgtype = "C11";
        } elseif($usorgtype == "Incorporated within one of the U.S. states") {
            $usorgtype = "C21";
        }
        if($usorgtype == "") {
            $usorgtype = "C31";
