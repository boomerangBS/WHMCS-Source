...
class Settings
{
    public function getTemplateVariables()
    {
        ...
        if(empty($systemUrl)) {
            $systemUrl = (new \WHMCS\Admin\Setup\GeneralSettings())->autoDetermineSystemUrl();
        }
    ...
    public function save($data)
    {
        ...
        if($logoUploaded) {
            try {
                ...
                $logoFileValidationFunctions = [".png" => "imagecreatefrompng", ".jpg" => "imagecreatefromjpeg", ".jpeg" => "imagecreatefromjpeg"];
        ...
        $generalSettings->autoSetInitialConfiguration($companyName, $email, $address, $country, $language, $logoUrl, $systemUrl);
    }
}
