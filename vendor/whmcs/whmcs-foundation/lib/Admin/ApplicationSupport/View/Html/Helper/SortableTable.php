...
class SortableTable
{
    ...
    public function storeUserSortData(array $data = [])
    {
    ...
    public function factoryPaginatedTable($tableNamespace, $columnOrderBy, $defaultOrderDirection = NULL, $page = 0, $limit = NULL)
    {
        ...
        } elseif($defaultOrderDirection) {
            $orderDirection = $defaultOrderDirection;
        } elseif($previousOrderDirection) {
        ...
        } elseif(!isset($sortData[$tableNamespace . $newTableId . "orderby"])) {
