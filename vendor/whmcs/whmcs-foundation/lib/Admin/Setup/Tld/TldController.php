...
class TldController
{
    ...
    private $graceFee;
    private $graceDuration;
    private $redemptionFee;
    private $redemptionDuration;
    private $tldIds = [];
    ...
    public function manageSpotlight(\WHMCS\Http\Message\ServerRequest $request) : \WHMCS\Http\Message\JsonResponse
    {
        $tld = $request->get("tld");
