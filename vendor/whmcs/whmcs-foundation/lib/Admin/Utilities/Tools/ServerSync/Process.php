...
class Process
{
    public static function import(SyncItem $syncItem, \WHMCS\Module\Server $moduleInterface, $serverId, array $additional = [])
    {
