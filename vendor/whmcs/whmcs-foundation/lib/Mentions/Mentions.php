...
class Mentions
{
    ...
    public static function doMentionReplacements(string $contentBody)
    {
        $mentions = self::getMentionReplacements($contentBody);
        return str_replace($mentions["find"], $mentions["replace"], $contentBody);
    }
