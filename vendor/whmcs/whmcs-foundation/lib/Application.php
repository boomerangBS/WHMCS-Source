...
class Application extends Init
{
    ...
    protected $phpSelf;
    const FILES_VERSION = "8.12.1-release.1";
    const RELEASE_DATE = "2025-01-17";
    ...
    public function redirectToRoutePath(string $route, array $routeVariables = [], array $queryParameters = [])
    {
    ...
    protected function shouldRedirectForIPBan()
    {
        ...
        if($this->isApiRequest() || Environment\Php::isCli()) {
            return false;
        }
        return true;
    }
    ...
    public function getVersion() : Version\SemanticVersion
    {
        return self::getFilesVersion();
    }
    public static function getFilesVersion() : Version\SemanticVersion
    {
