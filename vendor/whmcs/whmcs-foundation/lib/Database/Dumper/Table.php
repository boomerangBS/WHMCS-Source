...
class Table
{
    ...
    public function __construct(\WHMCS\Database\DatabaseInterface $database, string $tableName, array $options = [])
    {
    ...
    protected function getDataBatch($offset, int $limit) : \Illuminate\Support\Collection
    {
        try {
    ...
    protected function generateDataRow($row) : array
    {
