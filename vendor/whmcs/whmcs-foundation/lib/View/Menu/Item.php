...
class Item extends \Knp\Menu\MenuItem
{
    ...
    public function setName($name) : \Knp\Menu\ItemInterface
    {
    ...
    public function setUri($uri) : \Knp\Menu\ItemInterface
    {
        if(!$uri) {
            return $this;
        }
    ...
    public function setLabel($label) : \Knp\Menu\ItemInterface
    {
    ...
    public function getChild($name) : \Knp\Menu\ItemInterface
    {
        return parent::getChild($name);
    }
    public function copy() : \Knp\Menu\ItemInterface
    {
        return parent::copy();
    }
    ...
    public function getRoot() : \Knp\Menu\ItemInterface
    {
    ...
    public function getParent() : \Knp\Menu\ItemInterface
    {
        return $this->parent;
    }
    ...
    public function setChildren($children) : \Knp\Menu\ItemInterface
    {
        return parent::setChildren($children);
    }
    public function removeChild($name) : \Knp\Menu\ItemInterface
    {
    ...
    public function setExtras($extras) : \Knp\Menu\ItemInterface
    {
        return parent::setExtras($extras);
    }
    public function setExtra($name, $value) : \Knp\Menu\ItemInterface
    {
