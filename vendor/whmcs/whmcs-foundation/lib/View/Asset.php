...
class Asset
{
    ...
    protected function getFontCssPath()
    {
        return $this->getFontsPath() . "/css";
    }
    public static function fontCssPath($fileName)
    {
        return \DI::make("asset")->getFontCssPath() . "/" . $fileName;
    }
    public static function fontCssInclude($fontFileName)
    {
        return sprintf("<link href=\"%s\" rel=\"stylesheet\" type=\"text/css\" />", self::fontCssPath($fontFileName));
    }
