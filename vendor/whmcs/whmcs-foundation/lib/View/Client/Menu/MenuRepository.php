...
{
    protected $primaryNavbar;
    protected $secondaryNavbar;
    protected $primarySidebar;
    protected $secondarySidebar;
    protected $primaryNavbarFactory;
    protected $secondaryNavbarFactory;
    protected $primarySidebarFactory;
    protected $secondarySidebarFactory;
    protected $context = [];
    ...
    public function primaryNavbar($firstName = "", array $conditionalLinks = [])
    {
    ...
    public function secondaryNavbar($firstName = "", array $conditionalLinks = [])
    {
    ...
    public function addContext($key = NULL, $value) : void
    {
        if(!is_null($key)) {
