...
class Server extends AbstractModule
{
    ...
    public function setAddonId($addonId)
    {
        ...
        if($addonId) {
            ...
            $this->setServiceId($this->modelData->serviceId ?? 0, false);
        }
        return $this;
    }
    ...
    public function getModuleByServiceID($serviceID = 0)
    {
        ...
        if(!isset($this->modelData->product->module)) {
            return "";
        }
    ...
    {
        $serverId = $this->modelData->serverId ?? NULL;
    ...
    public static function getServerId(string $serverType, int $serverGroupId = 0)
    {
        $serverId = 0;
        $server = NULL;
    ...
    {
        return $this->callIfExists("isActive", true);
    }
