...
{
    public static $emailPreferencesDefaults;
    ...
    public function setEmailPreferences($preferences)
    {
        ...
        } elseif($this instanceof \WHMCS\User\Client\Contact) {
