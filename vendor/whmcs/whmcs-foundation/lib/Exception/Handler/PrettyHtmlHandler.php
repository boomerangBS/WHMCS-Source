        ...
        try {
            ...
            if(!$html) {
                ...
                if(\WHMCS\Admin::getId()) {
                    ...
                    } elseif(\WHMCS\User\Admin\Permission::currentAdminHasPermissionName("Configure General Settings")) {
            ...
            \WHMCS\Utility\ErrorManagement::isDisplayErrorCurrentlyVisible() or $showStacktrace = \WHMCS\Utility\ErrorManagement::isDisplayErrorCurrentlyVisible() || \WHMCS\User\Admin\Permission::currentAdminHasPermissionName("Configure General Settings");
            if($showStacktrace) {
