...
class ErrorManagement
{
    ...
    public static function enableIniDisplayErrors($setting = true)
    {
        ...
        if(is_string($setting)) {
            ...
            if($setting == "on" || $setting === "1" || $setting === "true") {
                $iniValue = true;
            } elseif($setting == "stderr" || $setting == "stdout") {
                $iniValue = $setting;
            } else {
    ...
    public static function distillErrorReportingLevelFromDisplayErrorSetting($setting = NULL)
    {
        ...
        } elseif(is_numeric($setting) && 0 <= $setting) {
    ...
    public static function errorsAsExceptions(\WHMCS\Config\AbstractConfig $config) : \WHMCS\Config\AbstractConfig
    {
