...
class Application extends AbstractBootstrap
{
    ...
    public static function verifyInstallerIsAbsent()
    {
        if(file_exists(ROOTDIR . "/install/install.php")) {
            if(\WHMCS\Config\Setting::getValue("Version") == \WHMCS\Application::FILES_VERSION) {
                $msg = "Application is up to date, but " . ROOTDIR . "/install directory is still present";
            } else {
                $msg = ROOTDIR . "/install directory exists but not expected.";
            }
    ...
    {
        return ["\\WHMCS\\Log\\LogServiceProvider", "\\WHMCS\\Route\\RouteServiceProvider", "\\WHMCS\\Application\\ApplicationServiceProvider", "\\WHMCS\\Api\\ApiServiceProvider", "\\WHMCS\\Smarty\\SmartyServiceProvider", "\\WHMCS\\View\\ViewServiceProvider", "\\WHMCS\\ClientArea\\ClientAreaServiceProvider", "\\WHMCS\\MarketConnect\\MarketConnectServiceProvider", "\\WHMCS\\Cart\\CartServiceProvider", "\\WHMCS\\Authentication\\Remote\\ServiceProvider", "\\WHMCS\\File\\StorageServiceProvider", "\\WHMCS\\User\\Validation\\UserValidationServiceProvider", "WHMCS\\Hook\\HookServiceProvider", "WHMCS\\Payment\\PaymentServiceProvider", "WHMCS\\Billing\\Gateway\\PaymentGatewayServiceProvider"];
    }
}
