...
class Download extends \WHMCS\Model\AbstractModel
{
    ...
    {
        return $this->belongsTo("WHMCS\\Download\\Category", "category", "id", "downloadCategory");
    }
    public function products()
    {
        return $this->belongsToMany("WHMCS\\Product\\Product", "tblproduct_downloads", "download_id", "product_id", "id", "id", "products");
    }
