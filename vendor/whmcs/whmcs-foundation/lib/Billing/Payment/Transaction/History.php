...
class History extends \WHMCS\Model\AbstractModel
{
    ...
    protected $columnMap = ["invoiceId" => "invoice_id", "transactionId" => "transaction_id", "remoteStatus" => "remote_status", "currencyId" => "currency_id"];
    ...
    {
        return $this->belongsTo("WHMCS\\Billing\\Invoice", "invoice_id", "id", "invoice");
    }
